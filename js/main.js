...
function initMap() {
  if ($("#contactsMap").length) {
    ...
    var myLatLng = {lat: 55.761432, lng: 37.552671};
    var myCenter = {lat: 55.7626, lng: 37.548671};
    ...
    google.maps.event.addDomListener(window, "load", function() {
      if ($("#mobile-indicator").css("display") == "block") {
        map.setCenter({lat: 55.762432, lng: 37.552671});
      } else {
        map.setCenter({lat: 55.7626, lng: 37.548671});
      }
